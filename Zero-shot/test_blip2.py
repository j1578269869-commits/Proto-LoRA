        ...
        for batch in tqdm(test_loader, desc="Evaluating"):
            ...
            outputs = model.generate(
                **inputs,
                ...
                # temperature=5.0,           #生成时使用的温度参数，值越小，生成的结果越 deterministic
                # do_sample=True,        #是否使用采样策略，False 表示不使用采样
...
def main():
    ...
    # train_path = "/home/NCUT/22/pk/ncut24/jz/AlignRE_LLaVA/data/new/mnre_llava_train.json"
    # train_path = "/home/NCUT/23/jz/AlignRE_LLaVA/data/new/test.json"
    # val_path = "/home/NCUT/22/pk/ncut24/jz/AlignRE_LLaVA/data/new/mnre_llava_val.json"
    val_path = "/home/NCUT/23/jz/AlignRE_LLaVA/data/new/mnre_llava_val.json"
    # test_path = "/home/NCUT/22/pk/ncut24/jz/AlignRE_LLaVA/data/new/mnre_llava_test.json"
    test_path = "/home/NCUT/23/jz/AlignRE_LLaVA/data/new/mnre_llava_test.json"
    # image_base_path = "/home/NCUT/22/pk/ncut24/jz/AlignRE_LLaVA/data/new/image"
    image_base_path = "/home/NCUT/23/jz/AlignRE_LLaVA/data/new/image"

    data_paths = [train_path, val_path, test_path]  # 假设这些变量已定义
    # dataset = MNREDataset(data_paths, image_base_path, processor, mode='train')
    # 创建数据集
