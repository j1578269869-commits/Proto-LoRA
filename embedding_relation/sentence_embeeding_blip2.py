...
def main():
    ...
    model = T5ForConditionalGeneration.from_pretrained(model_name, use_auth_token=token,torch_dtype=torch.float16)
    ...
    torch.save(emb_dict_list, 'data/embeddings_similarity.pt')
