...
plora_embeddings = torch.load(r'/home/NCUT/23/jz/AlignRE_flan-t5/data/similarity_embedding_Qwen2.pt').to("cuda")
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.disable_adapters:
            ...
            #使用小型网络 lora_rmoe 对输入进行打分，得到 softmax 权重分布
                ...
                # print(("(self.lora_dropout[self.active_adapter](x)",self.lora_dropout[self.active_adapter](x).shape))
                ...
                # print("self.plora_embeddings",self.plora_embeddings.shape)
