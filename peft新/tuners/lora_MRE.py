...
plora_embeddings = torch.load(r'/home/NCUT/23/jz/AlignRE_flan-t5/data/embeddings_similarity.pt').to("cuda")
@dataclass
...
class LoraLayer:
    def __init__(
        ...
        self.plora_embeddings = torch.load(r'/home/NCUT/23/jz/AlignRE_flan-t5/data/embeddings_similarity.pt').to("cuda")
